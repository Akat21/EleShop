  ...
  return (
    <div className='flex justify-around items-center h-full'>
        ...
        <div className='max-w-96'>
            ...
            <h1 className='font-bold text-4xl leading-snug mb-8'>{data.name}</h1>
        ...
        {/* Image Section */}
        <div>
            <Image src={data.picture} alt='Produkt' width={360} height={360} className='min-w-96 min-h-96 object-contain'/>
        </div>
