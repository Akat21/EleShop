...
const Contact = () => {
  return (
    <div className='flex h-56 justify-around items-center px-24 bg-slate-50 border-b-2 border-gray-300'>
        <div>
            <h1 className='text-3xl font-semibold mb-6'>Join Us & Get Updates</h1>
            <p className='text-slate-500 text-sm leading-relaxed'>Sign up for exclusive offers, latest info and updates</p>
        </div>
        <div className='flex'>
            <input type="text" className="h-11 w-80 border-2 border-gray-300 rounded-3xl px-4 py-2 mr-4 focus:outline-none focus:border-gray-300 focus:ring-0" placeholder="Enter your email" />
